...
NXAST_RAW_EXECUTE_PROG = 50  # Execute BPF program action
...
NXT_BPF_UPDATE_MAP = 34

# enum nxt_bpf_map_command
NXT_BPF_MAP_UPDATE = 0  # Update bpf map.
...
NX_BPF_MAP_UPDATE_FORMAT_PACK_STR = '!HHIIIIII4x'
NX_BPF_MAP_UPDATE_FORMAT_SIZE = 48
assert (calcsize(NX_BPF_MAP_UPDATE_FORMAT_PACK_STR) + NICIRA_HEADER_SIZE == NX_BPF_MAP_UPDATE_FORMAT_SIZE)
